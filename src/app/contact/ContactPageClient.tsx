...
const contactCopy = {
  ...
  ru: {
    heroTitle: 'Частные запросы',
    heroSupport: 'Мы отвечаем лично.',
    heroDescription:
      'Для стратегических проектов, индивидуальных заказов и конфиденциального сотрудничества. Мы лично рассматриваем обращения международных гостей, рекомендации партнеров и запросы, требующие понимания культурного контекста; прежде чем предложить решение, начать координацию или спроектировать доступ, каждый запрос изучается конфиденциально.',
    directLineLabel: 'ПРЯМАЯ ЛИНИЯ',
    directLineDescription: 'Прямая связь для частных запросов.',
    privateMessageLabel: 'ЛИЧНЫЕ СООБЩЕНИЯ',
    privateMessageDescription: 'Защищенный канал личной переписки.',
    emailLabel: 'ЭЛЕКТРОННАЯ ПОЧТА',
    emailDescription:
      'Для частных запросов, структурированных предложений и стратегического сотрудничества. Ранний разговор помогает определить темп, осуществимость и необходимый уровень координации между принимающими сторонами, культурными партнерами и локальными командами.',
    locationLabel: 'АДРЕС',
    locationDescription: 'Встречи проводятся только по предварительной договоренности.',
    mapsAriaLabel: 'Открыть расположение офиса CREARE в Google Maps — 32G7+P8 Şişli, İstanbul',
    meetingButtonAriaLabel: 'Запросить встречу с CREARE',
    meetingButtonLabel: 'Поговорить с CREARE™',
    imageAlt:
      'Ferko Signature Plaza в районе Шишли, Стамбул, где расположен офис CREARE Travel Consultancy Limited Co.',
    successTitle: 'Спасибо.',
    successMessage: 'Мы получили ваш запрос и свяжемся с вами в ближайшее время.',
    successReference: 'Номер обращения',
    formAriaLabel: 'Форма частного запроса',
    nameLabel: 'ИМЯ',
    namePlaceholder: 'Ваше имя',
    emailLabelField: 'ЭЛЕКТРОННАЯ ПОЧТА',
    emailPlaceholder: 'Ваш адрес электронной почты',
    intentLabel: 'ХАРАКТЕР ПРОЕКТА',
    intents: [
      'Частные путешествия',
      'Корпоративные и брендовые программы',
      'Культурные впечатления',
      'Доступ в особо закрытом формате',
      'Долгосрочное сотрудничество',
    ],
    messageLabel: 'СООБЩЕНИЕ',
    messagePlaceholder: 'Расскажите о вашем замысле...',
    messageHelper: 'Расскажите о задаче. Мы выстроим структуру.',
    submitAriaLabel: 'Отправить частный запрос',
    loadingLabel: 'ОТПРАВКА…',
    submitLabel: 'ОТПРАВИТЬ ЗАПРОС →',
    confidentiality: 'Все запросы рассматриваются лично и в условиях строгой конфиденциальности.',
    requiredName: 'Укажите ваше имя.',
    requiredEmail: 'Укажите адрес электронной почты.',
    invalidEmail: 'Введите корректный адрес электронной почты.',
    requiredMessage: 'Добавьте сообщение.',
    genericFailure: 'Не удалось отправить запрос. Пожалуйста, попробуйте еще раз.',
    globalCapabilityLabel: 'МЕЖДУНАРОДНАЯ РЕАЛИЗАЦИЯ',
    globalCapabilityText:
      'Реализация проектов в разных странах • Сотрудничество с брендами и институциями • Координация в нескольких регионах • Проекты с повышенными требованиями к безопасности — с вниманием к сдержанности, ясной коммуникации и практическим условиям работы в разных культурных и операционных контекстах.',
    operatingInternationally: 'Работаем на международном уровне.',
    roots: 'С опорой на Стамбул и Бодрум.',
    scope:
      'Масштаб проекта, сроки и формат взаимодействия обсуждаются конфиденциально, чтобы каждый проект переходил от запроса к планированию с необходимой ясностью, приватностью и локальной координацией.',
    locationScope: 'Стамбул • Бодрум • Международные проекты',
    contactSectionAriaLabel: 'Контактная информация и форма запроса',
    capabilitySectionAriaLabel: 'Возможности международной реализации',
    phoneAriaLabel: 'Позвонить CREARE по номеру +90 541 220 3000',
    whatsappAriaLabel: 'Связаться с CREARE через WhatsApp',
    emailAriaLabel: 'Написать CREARE по адресу direct@crearetravel.com',
  },
} as const;
